...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1 style="text-shadow: 1px 2px #FFFFFF;color: #000000"><%--<img src="img/icon.jpg" class="radius-circle rotate-hover" height="50" alt=""/>--%>教务管理系统</h1>
    </div>
...
<div class="leftnav">
    ...
    <ul>
        ...
        <li><a href="CourseServlet" target="right"><span class="icon-caret-right"></span>课程管理</a></li>
        <li><a href="StudentServlet" target="right"><span class="icon-caret-right"></span>学生管理</a></li>
        <li><a href="TeacherServlet" target="right"><span class="icon-caret-right"></span>教师管理</a></li>
        <li><a href="NoticeServlet" target="right"><span class="icon-caret-right"></span>公告管理</a></li>
